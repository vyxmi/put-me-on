  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col gap-8 px-6 py-12">
      ...
      <div className="flex flex-col gap-1">
        <span className="font-mono text-[11px] uppercase tracking-wider text-text-tertiary">display name</span>
        <span className="text-[15px] text-text-primary">{user.displayName}</span>
      </div>
      <div className="flex flex-col gap-1">
        <span className="font-mono text-[11px] uppercase tracking-wider text-text-tertiary">handle</span>
